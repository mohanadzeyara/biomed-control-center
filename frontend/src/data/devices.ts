...
export const learningDevices: LearningDevice[] = [
  {
    ...
    model: 'ecg',
    overview: {
      en: 'An ECG monitor records small voltage differences generated by the electrical activity of the heart. These signals are measured on the skin through electrodes and are usually in the millivolt range, so the device needs high-input-impedance sensing, patient protection, differential amplification, filtering, analog-to-digital conversion, and clear visualization. Important engineering problems are electrode contact quality, common-mode noise, 50 Hz mains interference, baseline drift, motion artifacts, ADC resolution, and safe isolation.',
      de: 'Ein EKG-Monitor misst kleine Spannungsunterschiede, die durch die elektrische Aktivitaet des Herzens entstehen. Diese Signale werden ueber Elektroden auf der Haut gemessen und liegen meist im Millivoltbereich, deshalb braucht das Geraet hochohmige Messung, Patientenschutz, Differenzverstaerkung, Filterung, Analog-Digital-Wandlung und klare Visualisierung. Wichtige technische Probleme sind Elektrodenkontakt, Gleichtaktstoerungen, 50-Hz-Netzstoerung, Basisliniendrift, Bewegungsartefakte, ADC-Aufloesung und sichere Isolation.',
    },
    workflow: [
      {
        en: 'The heart produces ionic currents; the electrode-skin interface converts them into electronic potentials.',
        de: 'Das Herz erzeugt ionische Stroeme; die Elektroden-Haut-Grenzflaeche wandelt sie in elektronische Potentiale um.',
      },
      {
        en: 'Lead cables, shielding, and driven-right-leg feedback reduce common-mode pickup before amplification.',
        de: 'Ableitungskabel, Schirmung und Driven-Right-Leg-Rueckkopplung reduzieren Gleichtakteinkopplung vor der Verstaerkung.',
      },
      {
        en: 'Input protection and isolation limit patient current and protect the analog front end during faults.',
        de: 'Eingangsschutz und Isolation begrenzen Patientstrom und schuetzen die Analogstufe bei Fehlern.',
      },
      {
        en: 'The instrumentation amplifier boosts only the differential ECG while rejecting shared 50 Hz interference.',
        de: 'Der Instrumentenverstaerker hebt nur das differentielle EKG an und unterdrueckt gemeinsame 50-Hz-Stoerung.',
      },
      {
        en: 'High-pass, low-pass, and notch filters reduce baseline drift, muscle noise, and mains interference.',
        de: 'Hochpass, Tiefpass und Kerbfilter reduzieren Basisliniendrift, Muskelrauschen und Netzstoerung.',
      },
      {
        en: 'The ADC samples the conditioned signal; software estimates heart rate and marks R peaks.',
        de: 'Der ADC tastet das aufbereitete Signal ab; Software schaetzt Herzfrequenz und markiert R-Zacken.',
      },
    ],
    deepDive: [
      {
    ...
    parts: [
      {
        ...
        details: { en: 'The useful ECG is small, so electrode placement, gel quality, contact pressure, and skin preparation strongly affect signal quality.', de: 'Das Nutz-EKG ist klein, deshalb beeinflussen Elektrodenposition, Gelqualitaet, Anpressdruck und Hautvorbereitung die Signalqualitaet stark.' },
        electrotechnics: { en: 'Related concept: potential difference, source impedance, contact resistance, and measurement loading.', de: 'GET-Bezug: Potentialdifferenz, Quellenimpedanz, Kontaktwiderstand und Messbelastung.' },
      },
      {
        id: 'skinInterface',
        name: { en: 'Electrode-skin interface', de: 'Elektroden-Haut-Uebergang' },
        function: { en: 'Converts ionic currents in tissue into electronic current in the measuring circuit.', de: 'Wandelt ionische Stroeme im Gewebe in elektronischen Strom in der Messschaltung um.' },
        details: { en: 'This interface behaves like a noisy impedance with capacitance and half-cell offset voltage; motion changes it during measurement.', de: 'Diese Grenzflaeche verhaelt sich wie eine rauschende Impedanz mit Kapazitaet und Halbzellen-Offsetspannung; Bewegung veraendert sie waehrend der Messung.' },
        electrotechnics: { en: 'Related concept: RC equivalent circuit, capacitance, thermal noise, offset voltage, and transient response.', de: 'GET-Bezug: RC-Ersatzschaltung, Kapazitaet, thermisches Rauschen, Offsetspannung und Einschwingverhalten.' },
      },
      {
        id: 'leads',
        ...
        details: { en: 'Cable motion, loop area, and poor shielding can introduce artifacts that look like physiological changes.', de: 'Kabelbewegung, Schleifenflaeche und schlechte Schirmung koennen Artefakte erzeugen, die wie physiologische Aenderungen aussehen.' },
        electrotechnics: { en: 'Related concept: capacitive/inductive coupling, shielding, twisted leads, and common-mode pickup.', de: 'GET-Bezug: kapazitive/induktive Einkopplung, Schirmung, verdrillte Leitungen und Gleichtaktstoerung.' },
      },
      {
        id: 'drl',
        name: { en: 'Driven right leg circuit', de: 'Driven-Right-Leg-Schaltung' },
        function: { en: 'Feeds an inverted common-mode signal back to the patient reference electrode.', de: 'Fuehrt ein invertiertes Gleichtaktsignal zur Referenzelektrode zurueck.' },
        details: { en: 'It lowers common-mode voltage and helps the amplifier stay inside its input range, but it must be current-limited for safety.', de: 'Sie senkt die Gleichtaktspannung und hilft dem Verstaerker im Eingangsbereich zu bleiben, muss aber strombegrenzt sein.' },
        electrotechnics: { en: 'Related concept: negative feedback, common-mode voltage, loop stability, and current limiting.', de: 'GET-Bezug: negative Rueckkopplung, Gleichtaktspannung, Schleifenstabilitaet und Strombegrenzung.' },
      },
      {
        id: 'protection',
        name: { en: 'Input protection', de: 'Eingangsschutz' },
        function: { en: 'Limits fault currents and clamps overvoltage before sensitive amplifier inputs.', de: 'Begrenzt Fehlerstroeme und klemmt Ueberspannungen vor empfindlichen Verstaerkereingaengen.' },
        details: { en: 'Protection resistors, diodes, and filters must protect electronics without adding too much noise or signal distortion.', de: 'Schutzwiderstaende, Dioden und Filter muessen Elektronik schuetzen, ohne zu viel Rauschen oder Signalverzerrung einzufuegen.' },
        electrotechnics: { en: 'Related concept: Ohm law, current limiting, diode clipping, leakage current, and fault analysis.', de: 'GET-Bezug: Ohmsches Gesetz, Strombegrenzung, Diodenbegrenzung, Ableitstrom und Fehlerfallanalyse.' },
      },
      {
        id: 'isolation',
        name: { en: 'Isolation barrier', de: 'Isolationsbarriere' },
        function: { en: 'Separates patient-connected circuitry from power and communication circuits.', de: 'Trennt patientennahe Schaltungen von Energieversorgung und Kommunikationsschaltungen.' },
        details: { en: 'Isolation reduces dangerous leakage paths and is essential when a patient is connected by conductive electrodes.', de: 'Isolation reduziert gefaehrliche Ableitpfade und ist wesentlich, wenn ein Patient leitend ueber Elektroden verbunden ist.' },
        electrotechnics: { en: 'Related concept: galvanic isolation, capacitance across barriers, leakage current, creepage, and clearance.', de: 'GET-Bezug: galvanische Trennung, Barrierekapazitaet, Ableitstrom, Kriechstrecke und Luftstrecke.' },
      },
      {
        id: 'amplifier',
        ...
        details: { en: 'The ECG may be around 1 mV while common-mode interference can be much larger, so high input impedance and high CMRR are critical.', de: 'Das EKG kann etwa 1 mV gross sein, waehrend Gleichtaktstoerungen viel groesser sein koennen; hohe Eingangsimpedanz und hoher CMRR sind entscheidend.' },
        electrotechnics: { en: 'Related concept: differential voltage, gain, input impedance, CMRR, saturation, and op-amp limitations.', de: 'GET-Bezug: Differenzspannung, Verstaerkung, Eingangsimpedanz, CMRR, Saettigung und OPV-Grenzen.' },
      },
      {
        id: 'cmrr',
        name: { en: 'Common-mode rejection', de: 'Gleichtaktunterdrueckung' },
        function: { en: 'Suppresses voltage that appears similarly on both measurement inputs.', de: 'Unterdrueckt Spannung, die an beiden Messeingaengen aehnlich anliegt.' },
        details: { en: 'Imbalanced electrode impedances convert common-mode interference into differential error, so perfect rejection is impossible in practice.', de: 'Unsymmetrische Elektrodenimpedanzen wandeln Gleichtaktstoerung in Differenzfehler um, daher ist perfekte Unterdrueckung praktisch unmoeglich.' },
        electrotechnics: { en: 'Related concept: superposition, differential/common-mode signals, bridge imbalance, and decibel ratios.', de: 'GET-Bezug: Superposition, Differenz-/Gleichtaktsignale, Brueckenunsymmetrie und Dezibelverhaeltnisse.' },
      },
      {
        id: 'highpass',
        name: { en: 'High-pass filter', de: 'Hochpassfilter' },
        function: { en: 'Reduces slow baseline drift from breathing, motion, or electrode polarization.', de: 'Reduziert langsame Basisliniendrift durch Atmung, Bewegung oder Elektrodenpolarisation.' },
        details: { en: 'A cutoff chosen too high can distort ST segments and slow physiological information.', de: 'Eine zu hohe Grenzfrequenz kann ST-Strecken und langsame physiologische Informationen verfaelschen.' },
        electrotechnics: { en: 'Related concept: RC time constant, cutoff frequency, phase shift, and transient settling.', de: 'GET-Bezug: RC-Zeitkonstante, Grenzfrequenz, Phasenverschiebung und Einschwingen.' },
      },
      {
        id: 'lowpass',
        name: { en: 'Low-pass filter', de: 'Tiefpassfilter' },
        function: { en: 'Reduces high-frequency muscle noise and electromagnetic interference.', de: 'Reduziert hochfrequentes Muskelrauschen und elektromagnetische Stoerung.' },
        details: { en: 'A cutoff chosen too low can round QRS peaks and reduce timing accuracy.', de: 'Eine zu niedrige Grenzfrequenz kann QRS-Zacken abrunden und die Zeitgenauigkeit verschlechtern.' },
        electrotechnics: { en: 'Related concept: frequency response, bandwidth, amplitude attenuation, and phase delay.', de: 'GET-Bezug: Frequenzgang, Bandbreite, Amplitudendaempfung und Phasenverzoegerung.' },
      },
      {
        id: 'notch',
        name: { en: '50 Hz notch filter', de: '50-Hz-Kerbfilter' },
        function: { en: 'Suppresses power-line interference around the mains frequency.', de: 'Unterdrueckt Netzstoerung um die Netzfrequenz.' },
        details: { en: 'A notch helps readability but can ring or remove nearby useful spectral content if designed badly.', de: 'Ein Kerbfilter verbessert Lesbarkeit, kann aber schwingen oder nahe Nutzanteile entfernen, wenn er schlecht ausgelegt ist.' },
        electrotechnics: { en: 'Related concept: resonant filter, quality factor, transfer function, and selective attenuation.', de: 'GET-Bezug: Resonanzfilter, Guete, Uebertragungsfunktion und selektive Daempfung.' },
      },
      {
        id: 'adc',
        name: { en: 'ADC', de: 'ADC' },
        function: { en: 'Converts the analog ECG into digital samples.', de: 'Wandelt das analoge EKG in digitale Abtastwerte um.' },
        details: { en: 'The ADC must preserve QRS timing and amplitude while avoiding aliasing and quantization loss.', de: 'Der ADC muss QRS-Zeitpunkt und Amplitude erhalten und gleichzeitig Aliasing und Quantisierungsverlust vermeiden.' },
        electrotechnics: { en: 'Related concept: sampling theorem, quantization, reference voltage, ADC resolution, and SNR.', de: 'GET-Bezug: Abtasttheorem, Quantisierung, Referenzspannung, ADC-Aufloesung und SNR.' },
      },
      {
        id: 'processor',
        name: { en: 'Signal processor', de: 'Signalprozessor' },
        function: { en: 'Detects R peaks, estimates heart rate, and prepares alarms or reports.', de: 'Erkennt R-Zacken, schaetzt Herzfrequenz und bereitet Alarme oder Berichte vor.' },
        details: { en: 'Software must distinguish real arrhythmia from artifacts caused by movement, poor contact, or saturation.', de: 'Software muss echte Arrhythmie von Artefakten durch Bewegung, schlechten Kontakt oder Saettigung unterscheiden.' },
        electrotechnics: { en: 'Related concept: digital filtering, thresholds, derivative methods, timing windows, and false positives.', de: 'GET-/Signalbezug: digitale Filter, Schwellwerte, Ableitungsmethoden, Zeitfenster und Fehlalarme.' },
      },
      {
        id: 'screen',
      ...
      {
        id: 'alarm',
        name: { en: 'Alarm system', de: 'Alarmsystem' },
        function: { en: 'Warns when heart rate, signal quality, lead contact, or device status becomes unsafe.', de: 'Warnt, wenn Herzfrequenz, Signalqualitaet, Elektrodenkontakt oder Geraetestatus unsicher werden.' },
        details: { en: 'Alarm logic needs thresholds, delays, priority levels, and artifact rejection so it does not alarm constantly.', de: 'Alarmlogik braucht Schwellwerte, Verzoegerungen, Prioritaeten und Artefaktunterdrueckung, damit sie nicht dauernd alarmiert.' },
        electrotechnics: { en: 'Related concept: comparators, hysteresis, state machines, reliability, and fail-safe behavior.', de: 'GET-/Systembezug: Komparatoren, Hysterese, Zustandsautomaten, Zuverlaessigkeit und Fail-Safe-Verhalten.' },
      },
      {
        id: 'power',
        name: { en: 'Power supply', de: 'Stromversorgung' },
        function: { en: 'Provides stable isolated supply rails for analog, digital, and display electronics.', de: 'Liefert stabile isolierte Versorgungsschienen fuer Analog-, Digital- und Anzeigeelektronik.' },
        details: { en: 'Ripple, grounding, battery state, and isolation affect both patient safety and signal noise.', de: 'Ripple, Massefuehrung, Batteriezustand und Isolation beeinflussen Patientensicherheit und Signalrauschen.' },
        electrotechnics: { en: 'Related concept: rectification, regulation, ripple, grounding, isolation converters, and energy storage.', de: 'GET-Bezug: Gleichrichtung, Regelung, Ripple, Massekonzept, isolierte Wandler und Energiespeicher.' },
      },
    ],
    demo: {
      ...
      explanation: {
        en: 'The raw ECG contains baseline drift, muscle noise, and 50 Hz mains interference. Processing makes R peaks easier to detect, but every filter is a tradeoff: too much filtering can distort clinically meaningful waveform timing and amplitude.',
        de: 'Das rohe EKG enthaelt Basisliniendrift, Muskelrauschen und 50-Hz-Netzstoerung. Verarbeitung macht R-Zacken leichter erkennbar, aber jeder Filter ist ein Kompromiss: zu starke Filterung kann klinisch relevante Zeitform und Amplitude verfaelschen.',
      },
      filters: [
        { en: 'Baseline correction', de: 'Basislinienkorrektur' },
        { en: 'Bandpass smoothing', de: 'Bandpass-Glaettung' },
        { en: 'Notch filter', de: 'Kerbfilter' },
        { en: 'R-peak detection', de: 'R-Zacken-Erkennung' },
      ],
      clipSteps: [
        { en: 'Skin potential appears', de: 'Hautpotential entsteht' },
        { en: 'Electrode interface converts it', de: 'Elektrodenuebergang wandelt es' },
        { en: 'Protection and isolation limit current', de: 'Schutz und Isolation begrenzen Strom' },
        { en: 'Amplifier rejects common-mode noise', de: 'Verstaerker unterdrueckt Gleichtakt' },
        { en: 'Filters clean drift and 50 Hz noise', de: 'Filter reinigen Drift und 50 Hz' },
        { en: 'ADC and software detect R peaks', de: 'ADC und Software erkennen R-Zacken' },
      ],
    },
  },
  {
